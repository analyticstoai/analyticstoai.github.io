...
$(document).ready(function () {
    ...
    // cases 2
    (function () {
        const cases = $('.js-cases-two'),
              sliderCases = cases.find('.js-cases-slider-two');
        ...
        sliderCases.slick({
            ...
            dots: false,
            arrows: true,
            prevArrow: sliderCases.parents('.js-cases-two').find('.js-prev-two'),
            nextArrow: sliderCases.parents('.js-cases-two').find('.js-next-two'),
            speed: 700,
            // fade: true,
            adaptiveHeight: true,
            responsive: [{
